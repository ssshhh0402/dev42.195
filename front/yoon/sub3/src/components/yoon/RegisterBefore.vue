  ...
  <v-row justify="center">
    <v-dialog  v-model="dialog" persistent max-width="1000px" @keydown.esc="ifClickESC()">
      <template v-slot:activator="{ on }">
        <v-icon left color="white" style="margin:0" x-large v-on="on">person</v-icon>
      </template>
      <v-card justify-center>
                ...
                <v-flex >
                    ...
                    <v-col cols="12">
                        <v-col height="1px" cols="8" style="margin:auto auto 0px auto;">
                            ID<v-text-field  background-color="#EEEEEE" outlined v-model="title" label="id*" required></v-text-field>
                        </v-col>
                        <v-col cols="8" style="margin:0px auto auto auto;">
                            PWD<v-text-field  background-color="#EEEEEE" type="password" outlined v-model="title" label="pwd*" required></v-text-field>
                        </v-col>
                        </v-col>                    
                    </v-row>
        ...
        <v-layout justify-center>
            <v-flex >  
                <v-btn style="margin:auto 3px auto auto;" width="3vw" color="#424242" large dark @click="dialog = false">Close</v-btn>
